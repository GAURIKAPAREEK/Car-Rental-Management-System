...
<?php $pageTitle = 'AURELIA MOTORS | Car Listing'; ?>
<!DOCTYPE HTML>
<html lang="en">
<head>
...
<!--Page Header-->
<section class="page-header listing_page lux-reveal">
  <div class="container">
...
<section class="listing-page">
  <div class="container">
    <div class="row am-listing-layout">
      <aside class="col-md-3 col-sm-12 am-listing-sidebar">
...
{  ?>
      ...
      <div class="col-md-9 col-sm-12 am-listing-main">
...
foreach($results as $result)
{  ?>
        <div class="product-listing-m gray-bg lux-reveal">
          <div class="product-listing-img">
            <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>">
              <img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="<?php echo htmlentities($result->VehiclesTitle);?>" loading="lazy">
            </a>
          </div>
